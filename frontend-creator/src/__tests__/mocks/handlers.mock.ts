/**
 * Mock MSW handlers for Jest tests
 * This replaces the real handlers.ts module during testing to avoid import.meta issues
 */
...
export const handlers = [
  ...
  // Dashboard endpoints
  http.get(`${baseURL}/dashboard/statistics`, () => {
  ...
  http.put(`${baseURL}/courses/:id`, async ({ params, request }) => {
    const { id } = params;
  ...
  http.delete(`${baseURL}/courses/:id`, ({ params }) => {
    const { id } = params;
    const course = mockApiResponses.courses.success.data.find(c => c.id === id);
  ...
  // Lesson endpoints
  http.get(`${baseURL}/lessons`, ({ request }) => {
    const url = new URL(request.url);
  ...
  http.get(`${baseURL}/modules/:moduleId/lessons`, ({ params }) => {
  ...
  http.post(`${baseURL}/modules/:moduleId/lessons`, async ({ params, request }) => {
    const { moduleId } = params;
  ...
  // Exercise endpoints
  http.get(`${baseURL}/exercises`, ({ request }) => {
    const url = new URL(request.url);
    const page = url.searchParams.get('page') || '1';
    const limit = url.searchParams.get('limit') || '10';
  ...
  http.post(`${baseURL}/exercises`, async ({ request }) => {
  ...
  http.post(`${baseURL}/lessons/:lessonId/exercises`, async ({ params, request }) => {
  ...
  http.get(`${baseURL}/sections/:sectionId/modules`, () => {
    const modules = [
      {
        id: 'module-1',
        name: 'Basic Vocabulary',
  ...
  http.get(`${baseURL}/error/network`, () => {
