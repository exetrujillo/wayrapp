...
import { moduleSchema, ModuleFormData } from '../../utils/validation';
import { Button } from '../ui/Button';

// Create a form schema without the ID field (similar to level and section forms)
const moduleFormSchema = moduleSchema;

// Form data type (module schema doesn't include ID, so we can use it directly)
type ModuleFormInput = ModuleFormData;

interface SimpleModuleFormProps {
  initialData?: Partial<ModuleFormInput>;
  onSubmit: (data: ModuleFormInput) => Promise<any>;
  onCancel: () => void;
  isSubmitting?: boolean;
}

export const SimpleModuleForm: React.FC<SimpleModuleFormProps> = ({
  initialData,
  onSubmit,
  onCancel,
  isSubmitting = false,
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div>
            ...
            <select
              ...
              disabled={isSubmitting}
            >
              <option value="basic_lesson">Basic Lesson</option>
            ...
            <p className="mt-1 text-xs text-gray-500">
              Choose the type of content this module will contain
            </p>
          </div>
        </div>
...
export default SimpleModuleForm;