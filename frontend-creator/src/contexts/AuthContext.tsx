      ...
      try {
        ...
        if (authService.isAuthenticated()) {
          try {
            ...
            console.log('Fetching user profile from /auth/me endpoint for session validation');
            const userData = await authService.getCurrentUserProfile();
            setUser(userData);
            console.log('User profile successfully fetched and validated from /auth/me endpoint');
          } catch (profileError: any) {
            console.error('Session validation failed when fetching user profile:', profileError);
          ...
          setUser(null);
          console.log('No valid authentication tokens found in storage');
        }
      } catch (err: any) {
